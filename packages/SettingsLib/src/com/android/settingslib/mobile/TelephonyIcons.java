...
public class TelephonyIcons {
    ...
    public static final int ICON_LTE = R.drawable.exthm_ic_lte_mobiledata;
    public static final int ICON_LTE_PLUS = R.drawable.exthm_ic_lte_plus_mobiledata;
    public static final int ICON_G = R.drawable.exthm_ic_g_mobiledata;
    public static final int ICON_E = R.drawable.exthm_ic_e_mobiledata;
    public static final int ICON_H = R.drawable.exthm_ic_h_mobiledata;
    ...
    public static final int ICON_1X = R.drawable.exthm_ic_1x_mobiledata;
    public static final int ICON_5G = R.drawable.exthm_ic_5g_mobiledata;
    public static final int ICON_5G_PLUS = R.drawable.exthm_ic_5g_plus_mobiledata;
    public static final int ICON_CWF = R.drawable.exthm_ic_carrier_wifi;
    public static final int ICON_5G_NSA = R.drawable.exthm_ic_5g_nsa_mobiledata;
